...
|-----------|-------|-------|-------|---------------|
| ELM-001 | elementary | 1 | 数の概念と数え方（1〜10） | |
| ELM-002 | elementary | 1 | たし算の基礎 | ELM-001 |
| ELM-003 | elementary | 1 | ひき算の基礎 | ELM-002 |
| ELM-004 | elementary | 1 | 10より大きい数（〜100） | ELM-001 |
| ELM-005 | elementary | 1 | 長さ・かさ・重さの基礎 | ELM-001 |
| ELM-006 | elementary | 1 | 時刻と時間の基礎 | ELM-001 |
| ELM-007 | elementary | 2 | かけ算・九九 | ELM-002 |
| ELM-008 | elementary | 2 | 大きい数（〜1000） | ELM-004 |
| ELM-009 | elementary | 2 | 長さの単位（cm・m） | ELM-005 |
| ELM-010 | elementary | 2 | 三角形と四角形 | |
| ELM-011 | elementary | 2 | かさの単位（dL・L） | ELM-005 |
| ELM-012 | elementary | 2 | 時刻と時間の計算 | ELM-006 |
| ELM-013 | elementary | 3 | わり算の基礎 | ELM-007 |
| ELM-014 | elementary | 3 | 大きい数（〜10000） | ELM-008 |
...
| ELM-022 | elementary | 4 | 分数の計算（同分母） | ELM-016 |
| ELM-023 | elementary | 4 | 面積の基礎（正方形・長方形） | ELM-010 |
| ELM-024 | elementary | 4 | 角度と分度器 | ELM-018 |
| ELM-025 | elementary | 4 | 垂直・平行と四角形の種類 | ELM-018 |
| ELM-026 | elementary | 4 | 折れ線グラフ | ELM-019 |
| ELM-027 | elementary | 5 | 整数の性質（倍数・約数） | ELM-007 |
| ELM-028 | elementary | 5 | 分数の計算（異分母・通分） | ELM-022 |
| ELM-029 | elementary | 5 | 小数の乗除 | ELM-021 |
...
| module_id | level | grade | title | prerequisites |
|-----------|-------|-------|-------|---------------|
| MID-001 | middle | 7 | 正負の数・絶対値 | ELM-004 |
| MID-002 | middle | 7 | 正負の数の四則計算 | MID-001 |
| MID-003 | middle | 7 | 文字と式・代入 | MID-002 |
| MID-004 | middle | 7 | 一次方程式 | MID-003 |
...
| MID-012 | middle | 8 | 平行と合同・証明の基礎 | MID-006 |
| MID-013 | middle | 8 | 三角形の合同条件 | MID-012 |
| MID-014 | middle | 8 | 平行四辺形の性質と証明 | MID-013 |
...
| PROB-001 | high | 10 | 確率の基礎・事象と確率 | COMB-001 |
| PROB-002 | high | 10 | 条件付き確率・独立と従属 | PROB-001 |
| GEO-001 | high | 10 | 平面図形・合同と相似 | MID-019 |
| GEO-002 | high | 10 | 整数の性質・約数と倍数 | ELM-027 |
...
| GEO-004 | high | 11 | 図形と方程式（直線・円） | FUNC-002 |
| GEO-005 | high | 11 | 軌跡と領域 | GEO-004 |
| TRIG-003 | high | 11 | 三角関数（一般角・弧度法） | TRIG-001 |
| TRIG-004 | high | 11 | 三角関数の加法定理と応用 | TRIG-003 |
| LOG-001 | high | 11 | 指数関数 | FUNC-001 |
| LOG-002 | high | 11 | 対数関数 | LOG-001 |
| CALC-001 | high | 11 | 微分の基礎・導関数 | FUNC-002 |
...
| MATR-001 | high | 12 | 行列の基礎・演算 | VEC-001 |
| MATR-002 | high | 12 | 行列の応用（連立方程式・変換） | MATR-001 |
